...
appveyor DownloadFile https://github.com/opencv/opencv/archive/3.4.zip -FileName c:\opencv\opencv-3.4.zip
7z x c:\opencv\opencv-3.4.zip -oc:\opencv -y
del c:\opencv\opencv-3.4.zip /q
appveyor DownloadFile https://github.com/opencv/opencv_contrib/archive/3.4.zip -FileName c:\opencv\opencv_contrib-3.4.zip
7z x c:\opencv\opencv_contrib-3.4.zip -oc:\opencv -y
del c:\opencv\opencv_contrib-3.4.zip /q
cd C:\opencv\build
...
cmake C:\opencv\opencv-3.4 -G "MinGW Makefiles" -BC:\opencv\build -DENABLE_CXX11=ON -DOPENCV_EXTRA_MODULES_PATH=C:\opencv\opencv_contrib-3.4\modules -DBUILD_SHARED_LIBS=ON -DBUILD_EXAMPLES=OFF -DBUILD_TESTS=OFF -DBUILD_PERF_TESTS=OFF -DBUILD_opencv_java=OFF -DBUILD_opencv_python=OFF -DBUILD_opencv_python2=OFF -DBUILD_opencv_python3=OFF -DBUILD_DOCS=OFF -DENABLE_PRECOMPILED_HEADERS=OFF -DBUILD_opencv_saliency=OFF -DCPU_DISPATCH= -Wno-dev
mingw32-make
mingw32-make install
copy c:\opencv\opencv-3.4\samples\data\dnn\bvlc_googlenet.prototxt C:\opencv\testdata\bvlc_googlenet.prototxt
...
rmdir c:\opencv\opencv-3.4 /s /q
rmdir c:\opencv\opencv_contrib-3.4 /s /q
