...
appveyor DownloadFile https://github.com/opencv/opencv/archive/4.0.0.zip -FileName c:\opencv\opencv-4.0.0.zip
7z x c:\opencv\opencv-4.0.0.zip -oc:\opencv -y
del c:\opencv\opencv-4.0.0.zip /q
appveyor DownloadFile https://github.com/opencv/opencv_contrib/archive/4.0.0.zip -FileName c:\opencv\opencv_contrib-4.0.0.zip
7z x c:\opencv\opencv_contrib-4.0.0.zip -oc:\opencv -y
