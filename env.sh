...
if [[ "$uname_val" == "Darwin" ]]; then
  ...
  export CGO_LDFLAGS="-L/usr/local/Cellar/opencv/3.3.0_3/lib -lopencv_core -lopencv_videoio -lopencv_imgproc -lopencv_highgui -lopencv_imgcodecs -lopencv_objdetect -lopencv_calib3d -lopencv_video"
