...
appveyor DownloadFile https://github.com/opencv/opencv/archive/4.0.1.zip -FileName c:\opencv\opencv-4.0.1.zip
7z x c:\opencv\opencv-4.0.1.zip -oc:\opencv -y
del c:\opencv\opencv-4.0.1.zip /q
appveyor DownloadFile https://github.com/opencv/opencv_contrib/archive/4.0.1.zip -FileName c:\opencv\opencv_contrib-4.0.1.zip
7z x c:\opencv\opencv_contrib-4.0.1.zip -oc:\opencv -y
