...
del c:\opencv\opencv-3.4.0.zip /q
appveyor DownloadFile https://github.com/opencv/opencv_contrib/archive/3.4.0.zip -FileName c:\opencv\opencv_contrib-3.4.0.zip
7z x c:\opencv\opencv_contrib-3.4.0.zip -oc:\opencv -y
del c:\opencv\opencv_contrib-3.4.0.zip /q
cd C:\opencv\build
...
copy c:\opencv\opencv-3.4.0\samples\data\dnn\bvlc_googlenet.prototxt C:\opencv\testdata\bvlc_googlenet.prototxt
