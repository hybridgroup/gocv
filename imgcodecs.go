...
func (c IMReadFlag) String() string {
	switch c {
	case IMReadUnchanged:
		return "read-unchanged"
	case IMReadGrayScale:
		return "read-gray-scale"
	case IMReadColor:
		return "read-color"
	case IMReadAnyDepth:
		return "read-any-depth"
	case IMReadAnyColor:
		return "read-any-color"
	case IMReadLoadGDAL:
		return "read-load-gdal"
	case IMReadReducedGrayscale2:
		return "read-reduced-grayscale2"
	case IMReadReducedColor2:
		return "read-reduced-color2"
	case IMReadReducedGrayscale4:
		return "read-reduced-grayscale4"
	case IMReadReducedColor4:
		return "read-reduced-color4"
	case IMReadReducedGrayscale8:
		return "read-reduced-grayscale8"
	case IMReadReducedColor8:
		return "read-reduced-color8"
	case IMReadIgnoreOrientation:
		return "read-ignore-orientation"
	case IMWriteJpegQuality:
		return "write-jpeg-quality"
	case IMWriteJpegProgressive:
		return "write-jpeg-progressive"
	case IMWriteJpegOptimize:
		return "write-jpeg-optimize"
	case IMWriteJpegRstInterval:
		return "write-jpeg-rst-interval"
	case IMWriteJpegLumaQuality:
		return "write-jpeg-luma-quality"
	case IMWriteJpegChromaQuality:
		return "write-jpeg-chroma-quality"
	case IMWritePngCompression:
		return "write-png-compression"
	case IMWritePngStrategy:
		return "write-png-strategy"
	case IMWritePngBilevel:
		return "write-png-bilevel"
	case IMWritePxmBinary:
		return "write-pxm-binary"
	case IMWriteWebpQuality:
		return "write-webp-quality"
	case IMWritePamTupletype:
		return "write-pam-tupletype"
	case IMWritePngStrategyDefault:
		return "write-png-strategy-default"
	case IMWritePngStrategyFiltered:
		return "write-png-strategy-filtered"
	case IMWritePngStrategyHuffmanOnly:
		return "write-png-strategy-huffman-only"
	case IMWritePngStrategyRle:
		return "write-png-strategy-rle"
	case IMWritePngStrategyFixed:
		return "write-png-strategy-fixed"
	}
	return ""
}
